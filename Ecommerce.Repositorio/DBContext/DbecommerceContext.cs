...
public partial class DbecommerceContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__A3C02A1036A6EEA0");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__AAA5CEC2F2E050AB");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__0988921051421F7F");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF97F51F3B42");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__BC1240BD7DFC609C");
